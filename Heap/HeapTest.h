...
#ifndef PLAY_WITH_ALGORITHMS_HEAPTEST_H
#define PLAY_WITH_ALGORITHMS_HEAPTEST_H
...
namespace HeapTest {
    ...
    void test() {
        ...
        SortTestHelper::testSort("Quick Sort 3 Ways", QuickSort3Ways::quickSort3Ways, arr4, n);
...
#endif //PLAY_WITH_ALGORITHMS_HEAPTEST_H
